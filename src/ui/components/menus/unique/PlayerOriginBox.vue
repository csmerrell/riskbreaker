...
<template>
    <MenuBox
        class="inset-[unset] flex w-[500px] flex-col items-start justify-center rounded-md border-[3px] border-amber-800 bg-bg p-3 text-white shadow-lg shadow-slate-950"
    >
        <div class="relative size-full">
            <div
                class="text-standard-sm absolute right-1 top-[2px] flex flex-row gap-2 text-amber-300 opacity-70"
            >
                <KeySprite command="confirm" size="sm" :scale="0.5" /> Select
            </div>
            <div class="mb-4 flex flex-col border-b border-yellow-700 pb-4">

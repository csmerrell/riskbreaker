...
export class ArcLine extends ex.Actor {
    ...
    private animationProgress: number = 0.0; // Tracks the progress of the animation (0 to 1)
    private animationSpeed: number = 0.05; // Speed of the animation
    ...
    constructor(start: ex.Vector, end: ex.Vector) {
        ...
        const control2 = ex.vec(start.x + (3 * (end.x - start.y)) / 4, end.y - 25); // Adjust for curve height

...
- (Basic) Locus Infusion
    - Target objects in the battlefield and infuse them with intent.
        - Forest:
            ...
            - Rock: Earthen wall, Rolling Boulder
    - Differs per biome.
    - Pets created this turn act immediately.
    - [Passive]:
...
- Mana Dispersal
    - Fill 25% of all allies' spend gauges.
    - Costs 70% infusion.
- Health Infusion
...
- Screw Bit
    ...
    - Stacks to 3.
- Siphon bit
    - Attach a siphon bit to 1 enemy. Attacks against the enemy restore hp/mp to the attacker.
- Dismantle Whack
    - Single target attack. +100% dmg to mechanical & enemies with goggle vulnerability.
- Infuse lens
    - Make a pet that examines all enemies and inflicts scrutinized on all enemies each turn.
- Infuse air
    - Pet that adds +15% hp barrier to all allies (including pets) each turn.
- Scrutinize
    - [Free] Burn. Examine one enemy, inflict scrutinized on it for 2 turns.
